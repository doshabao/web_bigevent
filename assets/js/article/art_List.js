$(function () {
    ...
    function renderPage(total) {
        laypage.render({
            ...
            jump: function (obj, first) {
                ...
                //如果first的值为true 证明是方式二除非的 否则就是方式一触发的
                console.log(first);
                console.log(obj.curr);
                //把最新的页码值，赋值到q这个查询参数对象中
                q.pagenum = obj.curr
                //根据最新的q 获取对于的数据列表，并渲染表格
    ...
    //通过代理的形式,为删除按钮  #remove-edit按钮绑定 点击事件
    $('tbody').on('click', '#remove-edit', function () {
        // 提示用户是否确认退出
        var id = $(this).attr('data-id');
        var len = $('#remove-edit').length
    ...
    //通过代理的形式,为编辑按钮  #btn-edit按钮绑定 点击事件
